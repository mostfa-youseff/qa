...
void main() {
  group('Documentation Module', () {
    test('DocService generates Markdown README', () async {
      ...
      await docService.generateDocs(repoUrl: 'example/sample_repo', format: 'markdown', outputType: 'readme');
    ...
    test('DocService generates RST README', () async {
      final docService = DocService();
      await docService.generateDocs(repoUrl: 'example/sample_repo', format: 'rst', outputType: 'readme');
    ...
    test('DocService generates AsciiDoc README', () async {
      final docService = DocService();
      await docService.generateDocs(repoUrl: 'example/sample_repo', format: 'asciidoc', outputType: 'readme');
